...
download.file(url = "https://www.bfs.admin.ch/bfsstatic/dam/assets/16944799/master", 
...
gesundheit_total <- gesundheit %>% 
  ...
  # Ersetze das p für provisorisch in der Jahresangabe für 2019
  mutate(jahr = str_replace(string = jahr,
                            pattern = "p",
                            replacement = "")) %>% 
...
write_csv(gesundheit_total, file = here("data/derived/kosten-des-gesundheitswesen-nach-leistung-summen.csv"))
...
write_csv(gesundheit_tidy_ab2010, file = here("data/derived/kosten-des-gesundheitswesen-nach-leistung.csv"))
